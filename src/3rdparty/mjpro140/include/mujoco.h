...
MJAPI void mjv_cameraInModel(mjtNum* headpos, mjtNum* forward, const mjvScene* scn);

// get camera info in room space: average left and right OpenGL cameras
MJAPI void mjv_cameraInRoom(mjtNum* headpos, mjtNum* forward, const mjvScene* scn);
...
// draw lines
MJAPI void mjr_lines(mjrRect viewport, int nline, const float* rgb, 
...
// 3D selection
MJAPI int mjr_select(mjrRect viewport, const mjvScene* scn, const mjrContext* con,
...
// multiply two poses
MJAPI void mju_mulPose(mjtNum* posres, mjtNum* quatres, const mjtNum* pos1,
                       const mjtNum* quat1, const mjtNum* pos2, const mjtNum* quat2);

// negate pose
MJAPI void mju_negPose(mjtNum* posres, mjtNum* quatres,
                       const mjtNum* pos, const mjtNum* quat);

// transform vector by pose
MJAPI void mju_trnVecPose(mjtNum* res, const mjtNum* pos, const mjtNum* quat,
                          const mjtNum* vec);
