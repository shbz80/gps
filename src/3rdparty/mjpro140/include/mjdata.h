...
struct _mjData
{
    ...
    int timer_ncall[mjNTIMER];      // number of calls over which duration accumulated
    mjtNum timer_duration[mjNTIMER];// accumulated duration in microsec
    int solver_iter;                // number of solver iterations
    mjtNum solver_trace[mjNTRACE];  // norm of residual projected gradient over iterations
