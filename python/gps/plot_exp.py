...
gps_dir = '/home/shahbaz/Research/Software/Spyder_ws/gps_bak/'
# exp_name = 'mjc_yumi_joint_full_dyn'
exp_name = 'mjc_yumi_joint_state'
itr = 10

exp_dir = gps_dir + 'experiments/' + exp_name + '/'
_data_files_dir = exp_dir + 'data_files/'
